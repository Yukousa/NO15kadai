<?php
$heading_top = get_field('section_post_heading_2_top');
$heading_bottom = get_field('section_post_heading_2_bottom');
$image = get_field('section_post_image_2');
$content = get_field('section_post_content_2');
