...
<main class="p-profile">
    ...
    <section class="p-profile-skill ">
        <div class="p-profile-skill__inner p-profile-skill-inner l-inner">
            ...
            <div class="p-profile-skill-inner-box__wrapper-bottom">
                <!-- デザイン -->
                <div class="p-profile-skill-inner__box  p-profile-skill-inner-box p-profile-skill-inner__box--design">
                ...
                <!-- コミュニケーション -->
                <div class="p-profile-skill-inner__box  p-profile-skill-inner-box p-profile-skill-inner__box--communication">
    ...
    <section class="p-profile__wrapper">
        <div class="p-profile__container p-profile-container">
            <article class="p-single-profile-content__body p-single-profile-content-body">
                <!-- 投稿画面ACF -->
                ...
                ?>
                    ...
                    ?>
                    <section class="c-single-content c-single-content--profile">
    ...
    <!-- プロフィール pc時サイドバー -->
    <aside class="p-profile__profile p-profile-profile l-inner">
        <div class="p-profile-profile__body">
            ...
            <div class="p-profile-profile__text">
                <p class="p-single-profile-profile__text--company">株式会社 XXXXXX</p>
                <p class="p-single-profile-profile__text--ja">田中 太郎</p>
                <p class="p-single-profile-profile__text--ja2">代表 田中 太郎</p>
                <p class="p-single-profile-profile__text--en">Tanaka Tarou</p>
            </div>
        </div>
        ...
        <div class="p-profile-profile__content p-profile-profile-content">
            <div class="p-profile-profile-content__inner p-profile-profile-content-inner">
                <h4 class="p-profile-profile-content-inner__title">経歴</h4>
                <p class="p-profile-profile-content-inner__text">ここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入る</p>
            </div>
            <div class="p-profile-profile-content__inner p-profile-profile-content-inner">
                <div class="p-profile-profile__content p-profile-profile-content">
                    <h4 class="p-profile-profile-content-inner__title">職歴</h4>
                    <p class="p-profile-profile-content-inner__text">ここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入るここにテキスト入る</p>
                </div>
            </div>
        </div>
