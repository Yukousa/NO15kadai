...
<main>
    <section class="p-mv">
        <div class="p-mv__inner">
            <h2 class="p-mv__title l-inner" data-en="contact">お問い合わせ</h2>
        </div>
    </section>
    <div class="p-breadcrumbs p-breadcrumbs--height" aria-label="breadcrumb">
    ...
    <section class="p-contact-thanks">
        ...
        <div class="p-contact-thanks__back">
            <a href="<?php echo esc_url(home_url('/')); ?>" class="c-btn03">TOPへ戻る</a>
</main>
