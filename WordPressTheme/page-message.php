        ...
        <div class="c-slide-item">
          <div class="c-slide-row1">
            <div class="c-slide-image1">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/image11.png" alt="WORKイメージ" width="310" height="200" loading="lazy">
            </div>
            <div class="c-slide-image2">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/image19.png" alt="WORKイメージ" width="620" height="200" loading="lazy">
            </div>
          </div>
          <div class="c-slide-row2">
            <div class="c-slide-image3">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/image04.png" alt="WORKイメージ" width="310" height="200" loading="lazy">
            </div>
            <div class="c-slide-image4">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/image12.png" alt="WORKイメージ" width="620" height="200" loading="lazy">
            </div>
          </div>
        </div>
